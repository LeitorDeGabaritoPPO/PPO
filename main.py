...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.btIniciar = tk.Button(self.master, width=15, height=4, text="Iniciar", command=self.start_thread,
                                   state='disable')
        self.btIniciar.place(x=250, y=50)

        self.btParar = tk.Button(self.master, width=15, height=4, text="Cancelar", command=self.btn_parar,
                                 state='disable')
    ...
    def select_gabarito(self):
        try:
            ...
            file_path = self.master.filename = tk.filedialog.askopenfilename(initialdir=os.path.dirname(__file__),
    ...
    def ajuda(self):
        self.caixaTexto.delete(1.0, tk.END)
        self.caixaTexto.insert(tk.INSERT,
                               'Ao iniciar o programa pela primeira vez será criado duas pastas, a "ProvasParaCorrigir" e '
    ...
    def sobre(self):
        self.caixaTexto.delete(1.0, tk.END)
        self.caixaTexto.insert(tk.INSERT,
                               'Este programa foi criado com a finalidade de colaborar com a correção das '
                               'provas e para o PPO do IFPE.\n\n')
        self.caixaTexto.insert(tk.INSERT,
                               'Criado por: \n Isaías Duarte \n João Carlos \n Júlio César')
